...
// Sizer.jsh, NumericControl.jsh and SectionBar.jsh are deliberately NOT
// included. Under #engine v8 the core provides HorizontalSizer, VerticalSizer,
// NumericControl, NumericEdit and SectionBar as built-in globals, and those
// headers declare them again as plain functions - which V8 refuses outright:
// "Identifier 'HorizontalSizer' has already been declared". Measured with a
// probe run headless: the classes are built in, the constants below are not.
...
class ForaxxStudioDialog extends Dialog
{
   constructor()
   {
      super();
