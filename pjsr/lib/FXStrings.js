...
var FX_UI =
{
   en:
   {
      ...
      starsNote:      "<p>The star field is a fixed broadband-style "
                      ...
                      + "0.7&middot;Oiii&nbsp;&nbsp;&nbsp;B = Oiii</p><p>The same on every palette: "
                      + "the palette decides how the nebula is coloured, not what the star mix "
                      + "is given. Only 2 channel mode changes it, where there is no Sii and red "
                      + "falls back to Ha.</p><p>Stars are broadband sources, "
      ...
      styleNote:      "<p>One list for the palette and its starting point: choosing an entry "
                      ...
                      + "luminance are left as you set them. You are free to move any slider "
                      + "afterwards.</p><p>The "
      ...
      normalizeBarTip: "<p>Brings the channels to a common brightness before they are combined, "
                      ...
                      + "minimum and its median, then a midtones curve that moves its median "
                      + "onto a target - a curve stretch, not a linear scale, so faint structure "
                      + "is lifted without the bright cores running away.</p><p>The target is the "
                      + "reference channel's median times that channel's own level below, so a "
                      + "level of 1.00 matches the reference exactly and anything else sits "
                      + "deliberately above or below it. On linear input the target is absolute "
                      + "instead: the stretch target replaces the reference median, and the "
                      + "levels multiply that.</p><p>This is "
   ...
   fr:
   {
      ...
      starsNote:      "<p>Le champ d'\u00e9toiles est une combinaison fixe de type large bande "
                      ...
                      + "m\u00eame sur toutes les palettes : la palette d\u00e9cide de la couleur de la "
                      + "n\u00e9buleuse, pas de ce qui nourrit le m\u00e9lange des \u00e9toiles. Seul le mode "
                      + "2 couches la change, o\u00f9 il n'y a pas de Sii et le rouge retombe sur "
                      + "Ha.</p><p>Les "
      ...
      styleNote:      "<p>Une seule liste pour la palette et son point de d\u00e9part : choisir une "
                      ...
                      + "normalisation, l'entr\u00e9e lin\u00e9aire, les \u00e9toiles, le HDR et la luminance "
                      + "gardent vos valeurs. Vous restez libre de bouger ensuite n'importe quel "
                      + "curseur.</p><p>Les entr\u00e9es <b>Foraxx</b> "
      ...
      normalizeBarTip: "<p>Am\u00e8ne les couches \u00e0 une luminosit\u00e9 commune avant leur combinaison, en "
                      ...
                      + "m\u00e9diane sur une cible - un stretch par courbe, pas une mise \u00e0 "
                      + "l'\u00e9chelle lin\u00e9aire : la structure t\u00e9nue est relev\u00e9e sans que les "
                      + "c\u0153urs brillants s'emballent.</p><p>La cible est la m\u00e9diane de la "
                      + "couche de r\u00e9f\u00e9rence multipli\u00e9e par le niveau de la couche ci-dessous : "
                      + "un niveau de 1,00 la fait co\u00efncider exactement avec la r\u00e9f\u00e9rence, "
                      + "toute autre valeur la place d\u00e9lib\u00e9r\u00e9ment au-dessus ou en dessous. Sur "
                      + "de l'entr\u00e9e lin\u00e9aire, la cible devient absolue : la cible de stretch "
                      + "remplace la m\u00e9diane de r\u00e9f\u00e9rence, et les niveaux la "
                      + "multiplient.</p><p>C'est le vrai rem\u00e8de \u00e0 un "
